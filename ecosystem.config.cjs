  ...
  apps: [
    {
      ...
      env: {
        ...
        // as the firewall/security group allows the port through — see
        // start_server.sh's own default (127.0.0.1) for local/dev runs,
        // which this overrides for the PM2/production entry point.
        HOST: "0.0.0.0",
        PORT: "7001",
      },
    },
