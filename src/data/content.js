...
// Bundle-only UI strings for the site footer, Products page and Contact
// page card — like COMMON, these aren't edited through the admin panel.
const FOOTER = {
...
export const COPY = perLang((lang) => ({
  ...
  common: COMMON[lang],
  footer: FOOTER[lang],
  products: PRODUCTS_UI[lang],
  contact: CONTACT_UI[lang],
